"""
Video processing routes for AI services
"""
import os
import subprocess
import logging
...
from utils.video_utils import remove_audio_from_video, normalize_audio_in_video
...
@video_bp.route('/convert_video/ultrastar/<folder_name>', methods=['POST'])
def convert_video(folder_name):
    ...
    try:
        ...
        # Strategy: Transcode to WebM
        logger.info(f"Transcoding to WebM")
...
@video_bp.route('/remove_audio_from_video/ultrastar/<folder_name>', methods=['POST'])
...
@video_bp.route('/song/ultrastar/<folder_name>/video_info', methods=['GET'])
